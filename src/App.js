...
function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-300 hover:-translate-y-1"
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-1">
          <Routes>
            ...
            <Route path="/hoardings/:id" element={<HoardingDetails />} />
